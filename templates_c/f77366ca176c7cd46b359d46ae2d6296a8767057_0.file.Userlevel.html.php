<?php
/* Smarty version 3.1.32, created on 2018-10-05 20:41:01
  from '/Applications/AMPPS/www/manager/views/Userlevel.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5bb7cc5d01d1c8_97685691',
...
function content_5bb7cc5d01d1c8_97685691 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- END Header -->
                    ...
                    <div class="block">
                        ...
                        <form action="Userlevel" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return true;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="example-text-input" name="example-text-input" class="form-control" placeholder="nome nivél de acesso">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea id="example-textarea-input" name="example-textarea-input" rows="7" class="form-control" placeholder="Descrição.."></textarea>
                                </div>
                            </div>
