$( document ).ready(function() {
  ...
  $("#form_users_two").submit(function( event ){
...
$('.btn_edit_users').click(function(){
  ...
  updateRecord('update', pKey, 'Users');
      ...
      $.confirm({
        ...
        buttons: {
          Sim: function () {
            ...
            document.location.href= "../"+dominioURL+"Users";
          },
          Não: function () {  }
        }
      });
